...
server.on("message", function (message, remote) {
  ...
  if (button2 == 1) {
    button2 = 0;
    server.send("Off!", remote.port, remote.address, function (error) {
      if (error) {
        console.log("Did not send signal");
      } else {
